...
4.For each student, read id, name, and marks and add them to an ArrayList.
...
## OUTPUT:
<img width="1523" height="646" alt="image" src="https://github.com/user-attachments/assets/0a8adc18-b4f7-42de-8ae0-9fc92d77de85" />



## RESULT:
Therfore the program successfully serializes an ArrayList of Student objects into a file and restores them through deserialization.
